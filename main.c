...
//     Matrix input = init_matrix(3, 1);
//     Layer test_layer = init_layer(3, 3);

//     Matrix forward_pass_result = forward_pass_layer(&test_layer, &input);
//     printf("\n\n");
//     printf("Input:\n");
//     print_matrix(&input);
//     print_layer(&test_layer);
//     printf("Output:\n");
//     print_matrix(&forward_pass_result);
//     printf("\n\n");
    ...
    ForwardPassResult activations = forward_pass(&network, &input);

    printf("Number of Activations\n");
    printf("%d\n", activations.num_activations);
    printf("Final Activation\n");
    print_matrix(&activations.activations[3]);

    printf("Truth Matrix:\n");
    print_matrix(&truth);

    Matrix cost = compute_cost_matrix(&activations.activations[3], &truth);
    printf("Cost Matrix:\n");
    print_matrix(&cost);
